function valint_rule_use_branch(AST)
% >> Rule
...
if strcmp(AST.get_type, 'I')
    if AST.get_num_children == 2
        % access function has two children(nodes), meaning a branch is not
        % used
        AST.add_valint_result(mfilename, 'warning', 'Use defined branches in access functions is recommended!', 5, 1);        
    end
end
end
